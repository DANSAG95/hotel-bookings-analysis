...
* **TA/TO is the dominant distribution channel**, with approximately 97.9K bookings.
...
* **City Hotels have a substantially higher cancellation rate than Resort Hotels**, at 41.73% versus 27.76%.
...
* The visual analysis suggests a **positive association between ADR and cancellation rate**, although this should be interpreted as an observed pattern rather than a causal relationship.
* ADR also shows **very limited variation across cities**, with Pune at approximately $104.03 compared with approximately $102.77 for the lowest city.
